...
<form action="reg" method="post">
	...
	<div class="mb-3">
  		...
  		<input type="password" value="<c:out value="${customer.password}"></c:out>" class="form-control" id="exampleFormControlInput4" name="tbPass" placeholder="Enter password" required="required">
	</div>
